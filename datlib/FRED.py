# -*- coding: utf-8 -*-
"""
Created on Sat Oct 17 22:26:09 2020
...
def gather_data(data_codes, start, 
    ...
    # to check if new column is the first column of data 
    # if true, then create a new dataframe, if not,add to existing dataframe 
    i = 0
    # dct.items() calls key and value that key points to
    for key, val in data_codes.items():
        if i == 0: # that means we havenot created a new dataframe yet 
